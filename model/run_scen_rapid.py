...
par_list = [
    ...
    "addon_up",
    # "addon_lo",
    "share_mode_up",  # cofire penetration rate
    # "demand",
    # "bound_activity_up",
...
def add_rapid_xcoal(scen):
    """Adds settings of rapidly phasing out
    coal-fired power plants (CFPPs) in Asian regions.

    Including:
    - no-new-CFPP policies,
    - pre-mature retirement of CFPPs.
    """
    scen.check_out()

    # Create data file list
    folder_path = Path(get_repo_root()) / INPUT_DIR / "scenario" / "2c_rapid"
